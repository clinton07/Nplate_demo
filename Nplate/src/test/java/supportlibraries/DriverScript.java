...
//	private ExecutionMode executionMode;
	...
	private void initializeTestReport()
	{
		...
		report.initialize();
		//report.setDriver(driver); - Modified
...
//		}
	...
	private void createTestLogHeader()
	{
		...
		report.addTestLogSubHeading("Date & Time",
				...
				"Browser", ": " + testParameters.getBrowser());
	...
	{
		scriptHelper = new ScriptHelper(report, driver);
	...
	private void executeTestIterations()
	{
		...
		//report.updateTestLog("Step1", "Login Successful", Status.PASS);
	}
	...
	{
	//	driver.quit();
		System.out.println("Report Path:" + reportPath.toString());
	}
	...
	{	
			...
			if(testExecutedInUnitTestFramework && testStatus.equalsIgnoreCase("Failed")) {
				//Assert.fail(report.getFailureDescription().toString());
			}
	}
